import { View, Text, Image, TouchableOpacity, ScrollView, TextInput, StatusBar, SafeAreaView } from "react-native";
  ...
  return (
    ...
    <View className="flex flex-row justify-between w-full py-2">
        ...
        <TouchableOpacity activeOpacity={0.7}>
          <Image source={icons.double} className="h-10 w-10" />
        </TouchableOpacity>
        <TouchableOpacity activeOpacity={0.7}>
      ...
      <View className="py-4">
        <Text className="text-5xl font-bold">Put-Away</Text>
      </View>
      ...
      <View className="flex flex-row justify-between w-full py-4">
        <TabIcon name="To Do &#183; 3" focused={selectedTab === "Todo"} onPress={() => setSelectedTab("Todo")} />
